...
(function (global) {
  ...
  const PHRASES = {
    ...
    ja: {
      ...
      , '도쿄메이트의 홈그라운드 — 가장 상세한 안내가 가능해요': '東京メイトのホームエリア — 最も詳しいご案内が可能です', '관광지 위치': '観光スポットの位置', '눌러서 선택 · 해제': '選択・解除', '눌러서 제거': '削除',
    ...
    zh: {
      ...
      , '도쿄메이트의 홈그라운드 — 가장 상세한 안내가 가능해요': '东京旅行达人的主场 — 可提供最详细的指南', '관광지 위치': '景点位置', '눌러서 선택 · 해제': '选择或取消', '눌러서 제거': '移除',
